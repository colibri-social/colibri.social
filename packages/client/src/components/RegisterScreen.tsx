...
export const RegisterScreen: Component = () => {
	...
	return (
		<section class="pt-24 pb-8 mx-auto w-full max-w-336 md:px-16 px-6 relative flex flex-col items-center gap-8 min-h-screen animate-in fade-in-0 slide-in-from-bottom-2 duration-500 motion-reduce:animate-none">
