...
export const CheckboxLabel = <T extends ValidComponent = "label">(
	...
	return (
		<CheckboxPrimitive.Label
			...
			class={cx(
				"flex items-center cursor-pointer gap-2 text-sm leading-none font-medium select-none data-[disabled]:pointer-events-none data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50",
	...
	return (
		...
		>
			<CheckboxPrimitive.Indicator
				...
				class="flex items-center justify-center [&>svg]:text-foreground! transition-none"
			>
				<svg
