...
export const TooltipContent = <T extends ValidComponent = "button">(
	...
	return (
		<TooltipPrimitive.Content
			...
			class={cx(
				"bg-secondary drop-shadow-black/75 drop-shadow-sm text-secondary-foreground animate-in fade-in-0 zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 z-50 w-fit origin-(--kb-tooltip-content-transform-origin) rounded-md px-3 py-1.5 text-xs text-balance",
